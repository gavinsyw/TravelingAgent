...
import com.example.travelingagent.entity.Hotel;
...
public class CustomizationActivity extends AppCompatActivity implements OnGetRoutePlanResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itinerary.getSpotNum() != 0) {
                    ...
                    Toast.makeText(CustomizationActivity.this, "选择下一站以完善行程", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        if (ContextCompat.checkSelfPermission(CustomizationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            permissionList.add(Manifest.permission.ACCESS_FINE_LOCATION);
        }
        if (ContextCompat.checkSelfPermission(CustomizationActivity.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (!permissionList.isEmpty()) {
            ...
            ActivityCompat.requestPermissions(CustomizationActivity.this, permissions, 1);
        }

        Toast.makeText(CustomizationActivity.this, "选择您将要入住的酒店", Toast.LENGTH_SHORT).show();
        ...
        final BaiduMap.OnMarkerClickListener markerClickListenerChosen = new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                View view = View.inflate(CustomizationActivity.this, R.layout.content_simulation, null);
                ...
                final DialogPlus dialog = DialogPlus.newDialog(CustomizationActivity.this)
                ...
                button_yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mSearch.setOnGetRoutePlanResultListener(CustomizationActivity.this);
    ...
    private void saveItinerary(ItineraryClientApi itineraryClientApi, Itinerary itinerary) {
        ...
        call.enqueue(new Callback<Itinerary>() {
            ...
            public void onResponse(Call<Itinerary> call, Response<Itinerary> response) {
                ...
                Toast.makeText(CustomizationActivity.this, "行程已添加", Toast.LENGTH_SHORT).show();
            }
    ...
    private void getSpotData() {
        ...
        call.enqueue(new Callback<List<Spot>>() {
            ...
            public void onFailure(Call<List<Spot>> call, Throwable t) {
                Toast.makeText(CustomizationActivity.this, "failed", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
