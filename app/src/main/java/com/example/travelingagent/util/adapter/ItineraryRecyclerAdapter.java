...
public class ItineraryRecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public ItineraryRecyclerAdapter(Context context, List<DataBean> dataBeanList) {
