package com.example.travelingagent.util.pileLayout.widget;
 ...
 */
public class HorizontalTransitionLayout extends com.example.travelingagent.util.pileLayout.widget.BaseTransitionLayout {
