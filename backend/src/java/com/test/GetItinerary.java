...
　　
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("这是get itinerary请求");
            ...
            ResultSet rs_itinerary = state.executeQuery("select * from user_history where user_id =\'"+ user_id + "\' order by itineraryID;");
...
//                System.out.println("a path!");
            ...
            String jsonObject = gson.toJson(result.get(index));
