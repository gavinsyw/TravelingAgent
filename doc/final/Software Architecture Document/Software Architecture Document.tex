...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|} 
		...
		\hline 
        2019-06-18&2.0&Modify some diagrams.&Zhihui Xie \& Yiwen Song \& Huangfei Jiang\\
		\hline
		& & & \\
		\hline
		& & & \\
...
\begin{table}[htb]
	...
	\begin{tabular}{c|c|c|c} 
		...
		\hline 
		Log-in User&\tabincell{c}{Modify Information\\View History}&\tabincell{c}{Design Itinerary\\customization\\Recommandation}&Send User Feedback\\
		\hline
	\end{tabular}   
